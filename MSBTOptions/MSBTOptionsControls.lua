...
local function Colorswatch_OnClick(this)
	...
	ColorPickerFrame.swatchFunc = Colorswatch_ColorPickerOnChange
	...
	ColorPickerFrame.Content.ColorSwatchOriginal:SetColorTexture(tempR, tempG, tempB);
    ColorPickerFrame.Content.HexBox:OnColorSelect(tempR, tempG, tempB);
	ColorPickerFrame.Content.ColorPicker:SetColorRGB(tempR, tempG, tempB)
